...
async def _run_seed(db: AsyncSession):
    ...
    product_templates = {
        ...
        "breakfast-cereals": [
            ("Kelloggs Corn Flakes", "Classic crispy corn flakes packed with iron and vitamins. Enjoy with milk for a quick breakfast.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 129.00, ["250 g", "475 g", "875 g"]),
            ("Kelloggs Chocos", "Chocolatey whole wheat cereal balls kids love. Crunchy in milk with chocolate flavour.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 110.00, ["375 g", "700 g", "1.2 kg"]),
            ("Quaker Oats Porridge", "Gluten-sensitive instant oats with creamy texture. Ready in 2 minutes. Rich in beta-glucan.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 89.00, ["400 g", "800 g", "1.5 kg"]),
            ("Muesli (Saffola FITTIFY)", "High-fibre muesli with almonds, raisins, oats and wheat. No added sugar variant.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 159.00, ["400 g", "700 g", "1 kg"]),
            ("Granola (Yoga Bar)", "Crunchy oat granola with honey, almonds and cranberries. Great with yogurt or milk.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 195.00, ["300 g", "600 g", "1 kg"]),
            ...
            ("Protein Muesli (True Elements)", "High-protein seed and grain muesli with no refined sugar. 8g protein per serving.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 249.00, ["300 g", "500 g", "1 kg"]),
            ...
            ("Honey Cornflakes (Kelloggs)", "Crispy golden cornflakes drizzled with real honey. Sweeter, crunchier breakfast.", "https://images.unsplash.com/photo-1543733037-3c05fd8d01f4?auto=format&fit=crop&w=600&q=80", 145.00, ["250 g", "475 g", "875 g"]),
            ("Multi Grain Bread (Brown)", "100% wholegrain multigrain bread with seeds. High fibre, low GI breakfast choice.", "https://images.unsplash.com/photo-1549931319-a545dcf3bc7c?auto=format&fit=crop&w=600&q=80", 45.00, ["200 g", "400 g", "600 g"]),
        ],
        "baby-care": [
        ...
        "health-wellness": [
            ("Dabur Chyawanprash", "Classic immunity booster with 41 Ayurvedic herbs, amla and ghee. Trusted for 100+ years.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 149.00, ["250 g", "500 g", "1 kg"]),
            ("Himalaya Septilin Syrup", "Ayurvedic immunity booster to fight infections and support respiratory health.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 89.00, ["100 ml", "200 ml", "450 ml"]),
            ("Patanjali Ashwagandha Tablet", "Pure herbal ashwagandha tablets for stress relief, energy and immunity improvement.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 79.00, ["60 tablets", "120 tablets", "240 tablets"]),
            ("Ensure Nutrition Drink (Abbott)", "Complete balanced adult nutrition powder with 26 vitamins and minerals and whey protein.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 349.00, ["200 g", "400 g", "900 g"]),
            ("Horlicks Health Drink", "Classic malt-based health drink with essential nutrients. Helps children grow taller, stronger.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 199.00, ["200 g", "500 g", "1 kg"]),
            ("Glucon-D Energy Drink", "Instant energy glucose drink to replenish electrolytes and fight fatigue.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 79.00, ["100 g", "250 g", "500 g"]),
            ("Multivitamin Tablets (Revital H)", "Daily multivitamin with ginseng, minerals and natural vitamin complex for men.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 299.00, ["30 tablets", "60 tablets", "90 tablets"]),
            ("Omega-3 Fish Oil Capsules", "Pure fish oil softgels with EPA and DHA. Supports heart, joint and brain health.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 349.00, ["30 caps", "60 caps", "120 caps"]),
            ("Whey Protein (Optimum Nutrition)", "Gold Standard 100% whey protein for muscle recovery and growth. 24g protein per serving.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 2499.00, ["500 g", "1 kg", "2 kg"]),
            ("BP Monitor (Omron HEM)", "Digital automatic blood pressure monitor with memory storage and irregular heartbeat indicator.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 1999.00, ["Basic Model", "Advanced Model", "Premium Model"]),
            ("Thermometer (Digital)", "Fast 30-second digital thermometer for oral, rectal and underarm use. Fever alert beep.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 199.00, ["Basic", "Standard", "Premium"]),
            ...
            ("Vitamin D3 Capsules (1000 IU)", "Daily Vitamin D3 supplement for strong bones, immunity and mood support.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 249.00, ["30 caps", "60 caps", "90 caps"]),
            ...
            ("Triphala Powder (Patanjali)", "Classical Ayurvedic tridoshic herb blend for digestion, immunity and detoxification.", "https://images.unsplash.com/photo-1550572017-edd951aa8f72?auto=format&fit=crop&w=600&q=80", 75.00, ["100 g", "250 g", "500 g"]),
        ],
        "pet-care": [
